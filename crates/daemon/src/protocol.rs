...
pub struct DataCraftProtocol {
    ...
    /// Receipt store for TransferReceipts from requesters.
    ...
    pub async fn request_shard_from_peer(
        ...
        match status {
            WireStatus::Ok => {
                ...
                // Derive server node pubkey from PeerId (use raw bytes as placeholder)
                // TODO: resolve actual ed25519 public key from PeerId via DHT peer records
                let server_node = {
                ...
                let receipt = TransferReceipt {
                    ...
                    timestamp,
                    signature: vec![], // TODO: sign with requester's keypair
                };
                ...
                Ok(()) => {
                    ...
                    match bincode::deserialize::<TransferReceipt>(&payload) {
                        Ok(receipt) => {
                            ...
                            // TODO: verify receipt signature with requester's public key
                            info!(
